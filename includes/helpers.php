<?php
    ...
    /**
     * Check for back-link jn pages login and register php. If chack =0 back to login if = 1 back to register
     */
    $check = 0;
    ...
    function show_quote($value_php, $value)
    {
        render("{$value_php}.php", ["quote" => $value]);
    }
